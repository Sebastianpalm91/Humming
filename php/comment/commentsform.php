...
<?php foreach ($allComments as $comment):?>
  ...
  <blockquote class="blockquote mb-0 ml-4 pl-4 ">
    ...
    <p class="mb-0 smallfont"> Commented by: <a class="anchor-color" href="/php/allProfiles.php?id=<?php echo $comment['userID']?>"><?php echo $comment['username']; ?></a> on <?php echo $comment['commentDate']?>
    </p>
    <hr class="mt-1 mb-1 m-0">
    ...
    <?php foreach ($allReplys as $key => $value):?>
      ...
      <p class="mb-0 smallfont">
        Replied by: <a class="anchor-color" href="/php/allProfiles.php?id=<?php echo $value['userID']?>"><?php echo $value['username']?></a> on <?php echo $value['replyDate'] ?>
      </p>
    <?php endforeach; ?>
